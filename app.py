...
retail_data['Income'].fillna(retail_data['Income'].median(), inplace=True)
retail_data['Age'] = 2024 - retail_data['Year_Birth']
...
def page_2_layout():
    ...
    best_reg_rmse = regression_results.loc[regression_results['Dataset'] != 'V7', 'RMSE'].min()
    ...
    return html.Div([
        ...
        dbc.Row([
            ...
            dbc.Col(create_kpi_card("Best RMSE", f"{best_reg_rmse:.4f}", "fas fa-chart-area", "kpi-card-cyan", "kpi-icon-cyan"), lg=4, md=6, className="mb-4"),
